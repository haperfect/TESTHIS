...
public class TestLuongDichVu_13790 extends TiepNhanBenhNhan {
	...
	@Test(priority = 6)
	public void DichVu_13790_6() {
		clickOn(FormKhamBenh.FormKhamBenh_KetLuan);
		moveMouseHorizontallyFromLogo(FormKhamBenh.FormKhamBenh_HuongDieuTri, 302);
		s.click();
		
		// Chon kham them
		waitForObjectPresent(FormKhamBenh.HuongDieuTri_TaiKham, 4);
		clickOn(FormKhamBenh.HuongDieuTri_TaiKham);
