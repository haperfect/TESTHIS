...
public class TestLuongBHYT_13875 extends TiepNhanBenhNhan {
	...
	// BS01 kết luận, Kê toa thuốc và cho chuyển viện
	@Test(priority = 6)
	public void BHYT_13875_4() {
		clickOn(FormKhamBenh.FormKhamBenh_KetLuan);
		moveMouseHorizontallyFromLogo(FormKhamBenh.FormKhamBenh_HuongDieuTri, 297);
		s.click();
		waitForObjectPresent(FormKhamBenh.FormKhamBenh_ChuyenVien, 5);
		clickOn(FormKhamBenh.FormKhamBenh_ChuyenVien);
		sleep(2);
		// click tọa độ form chuyển đến bệnh viện
		clickToaDo(567, 308);
		waitForObjectPresent(FormKhamBenh.FormKhamBenh_BenhVienChuyen, 5);
		clickOn(FormKhamBenh.FormKhamBenh_BenhVienChuyen);
		sleep(2);
		s.type(Key.TAB);
		// Click tọa độ chọn lý do chuyển viện
		clickToaDo(966, 306);
		...
		sleep(2);
		waitForObjectPresent(FormKhamBenh.FormKhamBenh_InGiayChuyenVien, 5);
		clickOn(FormKhamBenh.FormKhamBenh_InGiayChuyenVien);
		if (waitForObjectPresent(FormKhamBenh.FormKhamBenh_GiayChuyenVien, 7)) {
			s.type(Key.F4, Key.ALT);
		...
		clickOn(FormKhamBenh.FormKhamBenh_In);
		sleep(2);
		clickOn(FormKhamBenh.FormKhamBenh_InDonThuoc);
		if (waitForObjectPresent(FormKhamBenh.FormKhamBenh_DonThuoc, 7)) {
			s.type(Key.F4, Key.ALT);
