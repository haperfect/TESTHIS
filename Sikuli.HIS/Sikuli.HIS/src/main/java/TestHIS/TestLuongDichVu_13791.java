...
public class TestLuongDichVu_13791 extends TiepNhanBenhNhan {
	...
	@Test(priority = 6)
	public void DichVu_13791_6() {
		clickOn(FormKhamBenh.FormKhamBenh_KetLuan);
		moveMouseHorizontallyFromLogo(FormKhamBenh.FormKhamBenh_HuongDieuTri, 296);
		s.click();
		sleep(2);
		clickOn(FormKhamBenh.HuongDieuTri_DieuTriNgoaiTru);
		sleep(2);
		// Tạm thời dừng tại đây vì chưa có thêm đặc tả từ phía BA cho việc xử lý tiếp theo 
