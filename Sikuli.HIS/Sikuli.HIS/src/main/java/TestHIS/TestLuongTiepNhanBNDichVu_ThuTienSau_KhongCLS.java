...
public class TestLuongTiepNhanBNDichVu_ThuTienSau_KhongCLS extends TiepNhanBenhNhan {
	...
	public void TestLuongTiepNhanBenhNhanDichVu_ThuTienSau_7() {
		...
		thoatTaikhoanvaDangNhapBangTaikhoankhac(HisActions.ten_dangNhap_THUNGAN01, HisActions.matKhau_dangNhap_THUNGAN01);
