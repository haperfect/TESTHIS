...
public class TestLuongBHYT_13856 extends TiepNhanBenhNhan {
	//Luồng 1.1 Tiếp nhận 1 BN BHYT, check thu tiền sau, chọn dịch vụ có thu chênh lệch, khám bệnh, không chỉ định cận lâm sàng
	
	public String Hoten, NgaySinh, SoCMND, GioiTinh, SoDienThoai, NgheNghiep, DanToc, NhapNhanh, SoNha, NoiLamViec;
	public String NguoiLienHe, SoDienThoaiNguoiLienHe, DoiTuong, UuTien, HinhThuc, LiDo, TenDichVu, ThuTienSau, NoiThucHien;
    ...
    //BS01 kết luận, cho ve khong toa thuoc
	@Test(priority = 6)
	public void BHYT_13856_4(){
	...
	public void BHYT_13856_6() {
		...
		if (tongSoDanhMuc.equalsIgnoreCase("1")) {
