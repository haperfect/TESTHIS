...
public class TestLuongBHYT_13867 extends TiepNhanBenhNhan {
	...
	public void BHYT_13856_2_2() {
		...
		waitForObjectPresent(HisActions.HIS_MenuKhamBenh, 5);
		// Click toa do submenu kham benh
		clickToaDo(212, 76);
		sleep(3);
	...
	// BS01 kết luận, Khám thêm và kê toa thuoc
	@Test(priority = 6)
	// BS01 kham benh, kham them và kê toa
	public void BHYT_13867_4() {
		clickOn(FormKhamBenh.FormKhamBenh_KetLuan);
		moveMouseHorizontallyFromLogo(FormKhamBenh.FormKhamBenh_HuongDieuTri, 297);
		s.click();
		waitForObjectPresent(FormKhamBenh.FormKhamBenh_KhamThem, 5);
		clickOn(FormKhamBenh.FormKhamBenh_KhamThem);
		sleep(3);
		// s.type(Key.TAB);
		clickToaDo(568, 311);
		waitForObjectPresent(FormKhamBenh.FormKhamBenh_DichVuKhamThem, 5);
		clickOn(FormKhamBenh.FormKhamBenh_DichVuKhamThem);
		clickToaDo(554, 433);
		...
		sleep(2);
		clickOn(FormKhamBenh.FormKhamBenh_InPhieuKhamThem);
		if (waitForObjectPresent(FormKhamBenh.FormKhamBenh_PhieuKhamThem, 7)) {
			s.type(Key.F4, Key.ALT);
			setTestcaseStatus("PASS", "In thành công!");
		} else {
			setTestcaseStatus("FAIL", "In không thành công!");
		}
		sleep(5);
		clickOn(FormKhamBenh.FormKhamBenh_In);
		sleep(2);
		clickOn(FormKhamBenh.FormKhamBenh_InPhieuKhamBenh);
		if (waitForObjectPresent(FormKhamBenh.FormKhamBenh_PhieuKhamBenh, 7)) {
			s.type(Key.F4, Key.ALT);
			setTestcaseStatus("PASS", "In thành công!");
		} else {
			setTestcaseStatus("FAIL", "In không thành công!");
